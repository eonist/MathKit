...
class TrigParser {
     ...
     * - Parameter: a is the pivot point
     * - Parameter: b is the polar point
   ...
   static func angleSpan3(pivot: CGPoint, a: CGPoint, b: CGPoint) -> CGFloat {
     ...
     * - Parameter angle between -3.14 and +3.14 (if you want to use angles from 0 to 6.28 use Angle.normalize2 on the PARAM: angle first)
     * - Parameter horizontalAxis: horizontal axis multiplier
     * - Parameter verticalAxis: vertical axis multiplier
     ...
     * - Parameter: a The first angle (between 0 and 2PI)
     * - Parameter: b The second angle (between 0 and 2PI)
